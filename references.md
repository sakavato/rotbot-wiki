...
이 자료는 작성자가 청강한 5일 사내 교육의 키워드 메모와 로봇 제어 파이프라인 도식을 출발점으로 삼았다. 독자와 학습 목적은 [첫 페이지](README.md#audience)에, 당시 메모에 기록된 교육 구성은 [일자별 안내](learning_path.md)에 정리했다. 원본 표현의 교정과 보완 관계는 [검토 기록](curriculum_coverage_and_gaps.md)에서 확인할 수 있다.
